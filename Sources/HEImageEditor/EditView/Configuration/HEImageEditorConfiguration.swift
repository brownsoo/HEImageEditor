...
public class HEImageEditorConfiguration: NSObject {
    ...
    public var wordings = HEEditorWordings()
    
    /// 최대 이미지 스티커 수
    public var maxImageStickersCount = 50
    /// 최대 텍스트 스티커 수
    ...
    private var _tools: [HEImageEditorConfiguration.EditTool] = [.textSticker,  .imageSticker, .clip, .filter, .mosaicDraw, .adjust, .draw]
